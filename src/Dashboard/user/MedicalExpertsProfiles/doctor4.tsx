        ...
        <div className="flex flex-col md:flex-row items-start justify-center max-w-6xl w-full p-4">
          ...
          <div className="bg-white shadow-lg rounded-lg p-6 w-full md:w-1/3 md:ml-6 mb-6 md:mb-0">
            <div className="flex flex-col items-center">
              <img
                src={doctorImage}
                alt="Dr. Obstetrics & Gynecology"
                className="w-48 h-48 object-cover mb-6 rounded-full border-4 border-gray-300"
              />
              <h2 className="text-2xl font-semibold text-center mb-4 text-blue-900">Dr. Sarah Wilson</h2>
              <h1 className="text-2xl font-semibold text-center mb-4 text-blue-900">Consultant Obstetrics & Gynecology</h1>
            </div>
          ...
          <div className="bg-white shadow-lg rounded-lg p-6 w-full md:w-2/3 md:ml-4">
            <h3 className="text-lg mb-2 text-gray-700"><strong>Qualifications :</strong> MBBS, MD (Obstetrics & Gynecology)</h3>
            <h3 className="text-lg mb-4 text-gray-700"><strong>Experience :</strong> Senior Obstetrician, Women's Health Clinic</h3>
            <h3 className="text-lg mb-8 text-center text-gray-700"><strong> Director & Chief Consultant Obstetrics & Gynecology</strong></h3>
...
export default DoctorObstetricsGynecology;
