...
import doctorImage from "../../../assets/Images/doctor3.jpg"; // Update the image path if necessary

const DoctorRadiology: React.FC = () => {
        ...
        <div className="flex flex-col md:flex-row items-start justify-center max-w-6xl w-full p-4">
          ...
          <div className="bg-white shadow-lg rounded-lg p-6 w-full md:w-1/3 md:ml-6 mb-6 md:mb-0">
            <div className="flex flex-col items-center">
              ...
              />
              <h2 className="text-2xl font-semibold text-center mb-4 text-blue-900">Dr. Michael Brown</h2>
              <h1 className="text-2xl font-semibold text-center mb-4 text-blue-900">Consultant Radiology</h1>
            </div>
          ...
          <div className="bg-white shadow-lg rounded-lg p-6 w-full md:w-2/3 md:ml-4">
            <h3 className="text-lg mb-2 text-gray-700"><strong>Qualifications :</strong> MBBS, MD (Radiology)</h3>
            <h3 className="text-lg mb-4 text-gray-700"><strong>Experience :</strong> Senior Radiologist, City Hospital</h3>
            <h3 className="text-lg mb-8 text-center text-gray-700"><strong> Director & Chief Consultant Radiology</strong></h3>
              ...
              <tbody>
                {['mon', 'tue', 'wed', 'thu', 'fri'].map((day, index) => (
                  <tr key={index} className="border-t">
                    ...
                    <td className="px-4 py-2 text-right text-gray-600">09:00am - 4:00pm</td>
...
export default DoctorRadiology;
